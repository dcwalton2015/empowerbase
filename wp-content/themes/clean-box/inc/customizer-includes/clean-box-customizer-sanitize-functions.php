 ...
 * @since Clean Box 0.1
 */
function clean_box_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Clean Box 0.1
 */
function clean_box_sanitize_custom_css( $input ) {
	if ( '' != $input  ) {
 ...
 */
function clean_box_sanitize_image( $image, $setting ) {
	/*
...
/**
 * Sanitizes page/post id
 * @param  $input entered value
 * @return sanitized output
 *
 * @since Clean Box 0.1
 */
function clean_box_sanitize_page( $input ) {
...
/**
 * Sanitizes category list in grid_content
 * @param  $input entered value
 * @return sanitized output
 *
 * @since Clean Box 0.1
 */
function clean_box_sanitize_category_list( $input ) {
	if ( '' != $input  ) {
		if( in_array( 0, $input ) ) {
			return '0';
		}
 ...
 *                    the setting default.
 */
function clean_box_sanitize_number_range( $number, $setting ) {
 ...
 */
function clean_box_sanitize_select( $input, $setting ) {
 ...
 * @since Clean Box 1.2
 */
function clean_box_sanitize_important_link() {
	return false;
}